...
6. **Migraciones sin aplicar:** `0058` (bucket `corpus-normativo`), `0059` (regla de conteos en `clone_effectiveness`) y `0061` (`live_sessions.closing_notes`, informe de cierre de la clase en vivo, §8) están escritas, pero **no se han corrido en el SQL Editor**
